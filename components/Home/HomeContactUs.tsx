  ...
  return (
    <div className="flex justify-between w-full md:flex-row px-[150px] pt-8 pb-24 flex-col">
      <div className='flex flex-col space-y-8 w-2/4'>
        ...
        <p className='font-bold text-gray-500 leading-7'>Something to tell us? <br /> Fell free to contact us , we&apos;ll be  open and happy <br /> to receive your idea and consider it. </p>
      </div>
